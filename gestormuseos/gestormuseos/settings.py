"""
Django settings for gestormuseos project.
...
SECRET_KEY = 'da(5y9$snu3k4cy6sv^kz*vx16g92k$2+78deo(tclx&20uhuw'
...
LOGIN_REDIRECT_URL = "/" #donde quiero mandarlo reverse_lazy('dashboard')
